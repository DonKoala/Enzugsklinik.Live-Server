...
compileFinal "
    ...
    private[""_msg"",""_from""];
    _msg = ctrlText 3003;
    if(_msg == """") exitWith {hint ""Du musst etwas eingeben!"";};
...
compileFinal "
	...
	switch (_type) do
	{
		 ...
		 case 6:
        {
            ...
            hint parseText format [""<t color='#0000ff'><t size='2'><t align='center'>Polizei Meldung<br/><br/><t color='#33CC33'><t align='left'><t size='1'>An: <t color='#ffffff'>Alle Spieler<br/><t color='#33CC33'>Von: <t color='#ffffff'>APD<br/><br/><t color='#33CC33'>Nachricht:<br/><t color='#ffffff'>%1"",_msg];
