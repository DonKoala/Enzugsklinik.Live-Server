...
switch(true)do
{
	...
	case (_vehicle iskindof "C_Van_01_transport_F"): {_liter = 0.00900; _completeliter = 1250;};
	case (_vehicle iskindof "C_Van_01_box_F"): {_liter = 0.00900; _completeliter = 1350;};
	case (_vehicle iskindof "C_Van_01_fuel_F"): {_liter = 0.00900; _completeliter = 1600;};
	
	//Zamak
	case (_vehicle iskindof "I_Truck_02_transport_F"): {_liter = 0.00900; _completeliter = 4000;};
	case (_vehicle iskindof "I_Truck_02_covered_F"): {_liter = 0.00900; _completeliter = 4000;};
	case (_vehicle iskindof "I_Truck_02_fuel_F"): {_liter = 0.00900; _completeliter = 4000;};	
	case (_vehicle iskindof "I_Truck_02_box_F"): {_liter = 0.00900; _completeliter = 4000;};	

	//Hemett
	case (_vehicle iskindof "B_Truck_01_transport_F"): {_liter = 0.00900; _completeliter = 4500;};
	case (_vehicle iskindof "B_Truck_01_covered_F"): {_liter = 0.00900; _completeliter = 4500;};
	case (_vehicle iskindof "B_Truck_01_mover_F"): {_liter = 0.00900; _completeliter = 4500;};
	case (_vehicle iskindof "B_Truck_01_box_F"): {_liter = 0.00900; _completeliter = 4500;};
	case (_vehicle iskindof "B_Truck_01_Repair_F"): {_liter = 0.00900; _completeliter = 4500;};
	case (_vehicle iskindof "B_Truck_01_ammo_F"): {_liter = 0.00900; _completeliter = 4500;};	
	case (_vehicle iskindof "B_Truck_01_fuel_F"): {_liter = 0.00900; _completeliter = 4500;};
	case (_vehicle iskindof "B_Truck_01_medical_F"): {_liter = 0.00900; _completeliter = 4500;};

	//Tempest
	case (_vehicle iskindof "O_Truck_03_covered_F"): {_liter = 0.00900; _completeliter = 5000;};
	case (_vehicle iskindof "O_Truck_03_transport_F"): {_liter = 0.00900; _completeliter = 5000;};
	case (_vehicle iskindof "O_Truck_03_covered_F"): {_liter = 0.00900; _completeliter = 5000;};
	case (_vehicle iskindof "O_Truck_03_device_F"): {_liter = 0.00900; _completeliter = 5000;};
	case (_vehicle iskindof "O_Truck_03_fuel_F"): {_liter = 0.00900; _completeliter = 5000;};
