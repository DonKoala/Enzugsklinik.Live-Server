...
{
	// Tankgeschwindigkeit
	case (_vehicle iskindof "C_Offroad_01_F"): {_liter = 0.00900; _completeliter = 850;};
	case (_vehicle iskindof "C_SUV_01_F"): {_liter = 0.00900; _completeliter = 605;};
	case (_vehicle iskindof "C_Hatchback_01_F"): {_liter = 0.00900; _completeliter = 500;};
	case (_vehicle iskindof "C_Hatchback_01_sport_F"): {_liter = 0.00900; _completeliter = 500;};
	case (_vehicle iskindof "B_MRAP_01_F"): {_liter = 0.00900; _completeliter = 1205;};
	case (_vehicle iskindof "B_MRAP_01_hmg_F"): {_liter = 0.00900; _completeliter = 1205;};
	case (_vehicle iskindof "B_G_Offroad_01_armed_F"): {_liter = 0.00900; _completeliter = 850;};
	case (_vehicle iskindof "B_G_Offroad_01_F"): {_liter = 0.00900; _completeliter = 850;};
	case (_vehicle iskindof "I_MRAP_03_F"): {_liter = 0.00900; _completeliter = 1250;};
	case (_vehicle iskindof "O_MRAP_02_F"): {_liter = 0.00900; _completeliter = 1250;};
	case (_vehicle iskindof "O_MRAP_02_hmg_F"): {_liter = 0.00900; _completeliter = 1250;};
	case (_vehicle iskindof "B_Quadbike_01_F"): {_liter = 0.00900; _completeliter = 250;};
